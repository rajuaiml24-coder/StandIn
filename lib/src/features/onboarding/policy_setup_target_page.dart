...
class _PolicySetupTargetPageState extends State<PolicySetupTargetPage> {
  ...
  void initState() {
    super.initState();
    _value = widget.controller.officialPolicy?.minimumPercent ?? 75.0;
  }
            ...
            child: IntrinsicHeight(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('What is your\nrequired attendance?', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: navy, height: 1.2)),
