    ...
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Choose how you want to track your progress.', style: TextStyle(fontSize: 15, color: Color(0xFF667085))),
          const SizedBox(height: 32),
          _BasisCard(
            title: 'Hours',
            subtitle: 'Track actual time worked (e.g., 8h per day)',
